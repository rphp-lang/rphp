...
use super::{
    ...
    parameter_get_default_value_constant_name, parameter_get_name, parameter_get_type,
    parameter_has_type, parameter_is_array, parameter_is_callable, parameter_is_default_available,
    parameter_is_default_value_constant, parameter_is_optional, parameter_is_passed_by_reference,
...
pub(in crate::stdlib) fn register(eg: &mut ExecutorGlobals) -> Vec<Box<InternalFunction>> {
    ...
    register_method!(
        ...
        parameter_is_default_value_constant,
        1,
        0,
        []
    );
    register_method!(
        ...
        parameter_get_default_value_constant_name,
        1,
        0,
        []
    );
