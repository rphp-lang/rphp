...
use super::instruction::{
    ...
    ASSIGN_CV_REBIND, ASSIGN_OBJ_MODIFY, CALL_FLAG_CALLBACK_ARRAY_PIPELINE,
    ...
    FETCH_DIM_ERROR_SUPPRESS, FETCH_DIM_ISSET, FETCH_DIM_SILENT, FETCH_DYNAMIC_ERROR_SUPPRESS,
    FETCH_DYNAMIC_SILENT, FETCH_OBJ_ERROR_SUPPRESS, FETCH_OBJ_INCDEC, FETCH_OBJ_MODIFY,
    FETCH_OBJ_SILENT, INSTANCEOF_DYNAMIC_STATIC_SCOPE, Instruction, KnownScalarType,
    LATE_STATIC_PROP_EMBEDDED_SCOPE, NEW_FLAG_DYNAMIC_CLASS_NAME, NEW_FLAG_DYNAMIC_STATIC_SCOPE,
    NEW_FLAG_UNPACKED_ARGUMENTS, NEW_FLAG_VIRTUAL_DECLARED_READS,
    NEW_FLAG_VIRTUAL_OBJECT_ARRAY_PIPELINE, OpType, REFERENCE_RESULT_INTERNAL, SEND_FLAG_GLOBALS,
