...
use super::instruction::{
    ...
    ASSIGN_DIM_DIAGNOSTIC_GUARD, ASSIGN_DIM_ERROR_SUPPRESS, ASSIGN_DIM_INCDEC_DECREMENT,
    ...
    ASSIGN_PROP_MOVE_SOURCE, ASSIGN_PROP_RESULT_VALUE, BIND_ARRAY_APPEND_COMPOUND,
    ...
    FETCH_DIM_COMPOUND, FETCH_DIM_DESTRUCTURE, FETCH_DIM_EMPTY, FETCH_DIM_ERROR_SUPPRESS,
    FETCH_DIM_FUNC_ARG, FETCH_DIM_FUNC_ARG_NAMED, FETCH_DIM_FUNC_ARG_ROOT_CV, FETCH_DIM_ISSET,
    FETCH_DIM_MUTABLE, FETCH_DIM_REFERENCE_SOURCE, FETCH_DIM_SILENT, FETCH_DIM_UNSET,
    ...
    Instruction, JMP_NZ_RELEASE_TEMPS, KnownScalarType, LATE_STATIC_PROP_EMBEDDED_SCOPE,
    NEW_FLAG_DYNAMIC_CLASS_NAME, NEW_FLAG_DYNAMIC_STATIC_SCOPE, NEW_FLAG_UNPACKED_ARGUMENTS,
    NEW_FLAG_UNRESOLVED_LEXICAL_SCOPE, NEW_FLAG_VIRTUAL_DECLARED_READS,
    NEW_FLAG_VIRTUAL_OBJECT_ARRAY_PIPELINE, OBJ_PROP_FUNC_ARG, OBJ_PROP_REFERENCE_BIND,
