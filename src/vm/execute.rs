...
use super::instruction::{
    ...
    ASSIGN_CV_MOVE_SOURCE, ASSIGN_CV_REBIND, ASSIGN_DIM_UNSET_REBUILD, ASSIGN_OBJ_MODIFY,
    ...
    CALL_FLAG_OBJECT_ARRAY_CONSUMERS, CALL_FLAG_STAGED_CALLBACK_ARRAY_PIPELINE,
    ...
    FETCH_OBJ_MODIFY, FETCH_OBJ_SILENT, INSTANCEOF_DYNAMIC_STATIC_SCOPE, Instruction,
    ...
    NEW_FLAG_VIRTUAL_OBJECT_ARRAY_PIPELINE, OpType, REFERENCE_RESULT_INTERNAL,
    REFERENCE_SOURCE_MAY_BE_NONREFERENCEABLE, SEND_FLAG_GLOBALS, STATIC_PROP_DYNAMIC_NAME,
    STATIC_PROP_DYNAMIC_OWNER, UNSET_DIM_NESTED,
};
