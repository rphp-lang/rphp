...
use super::instruction::{
    ...
    NEW_FLAG_DYNAMIC_CLASS_NAME, NEW_FLAG_DYNAMIC_STATIC_SCOPE, NEW_FLAG_NAMED_ARGUMENTS,
    NEW_FLAG_PREPARE_ONLY, NEW_FLAG_PREPARED, NEW_FLAG_UNPACKED_ARGUMENTS,
    NEW_FLAG_UNRESOLVED_LEXICAL_SCOPE, NEW_FLAG_VALIDATE_ONLY, NEW_FLAG_VIRTUAL_DECLARED_READS,
