...
use super::instruction::{
    ...
    CLASS_CONST_DYNAMIC_NAME, CLASS_CONST_DYNAMIC_OWNER, Instruction, KnownScalarType,
    LATE_STATIC_PROP_EMBEDDED_SCOPE, NEW_FLAG_VIRTUAL_OBJECT_ARRAY_PIPELINE, OpType,
};
