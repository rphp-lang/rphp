...
| --- | --- | --- | --- |
| PHP compatibility | [Compatibility roadmap](roadmap-compatibility.md) | [Compatibility Agent](agent-strategy-compatibility.md) | The pinned PHP 8.5.6 AMD64 checkpoint is 1,819/5,599 with zero crashes or timeouts; select the highest-fanout front-end or runtime cluster without losing an exact pass. |
