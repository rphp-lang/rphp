...
| --- | --- | --- | --- |
| PHP compatibility | [Compatibility roadmap](roadmap-compatibility.md) | [Compatibility Agent](agent-strategy-compatibility.md) | Establish the pinned PHP 8.5.6 AMD64 contract at 1,815/5,599, remove its two crashes and one timeout first, then select the highest-fanout front-end or runtime cluster without losing an exact pass. |
