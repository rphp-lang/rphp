...
| --- | --- | --- | --- |
| PHP compatibility | [Compatibility roadmap](roadmap-compatibility.md) | [Compatibility Agent](agent-strategy-compatibility.md) | The pinned PHP 8.5.6 AMD64 checkpoint is 2,298/5,599 with zero crashes or timeouts; magic-method return contracts and direct enum restrictions now match PHP 8.5, with trait-imported enum magic methods and the next largest manifest cluster remaining. |
