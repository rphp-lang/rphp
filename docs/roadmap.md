...
| --- | --- | --- | --- |
| PHP compatibility | [Compatibility roadmap](roadmap-compatibility.md) | [Compatibility Agent](agent-strategy-compatibility.md) | The pinned PHP 8.5.6 AMD64 checkpoint is 1,992/5,599 with zero crashes or timeouts; select the next high-leverage ordinary runtime cluster while retaining legacy assertion deprecations as an explicit diagnostic gap. |
