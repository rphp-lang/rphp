...
| --- | --- | --- | --- |
| PHP compatibility | [Compatibility roadmap](roadmap-compatibility.md) | [Compatibility Agent](agent-strategy-compatibility.md) | The pinned PHP 8.5.6 AMD64 checkpoint is 2,301/5,599 with zero crashes or timeouts; direct and trait-imported enum magic/property restrictions now match PHP 8.5, with the next largest manifest cluster remaining. |
