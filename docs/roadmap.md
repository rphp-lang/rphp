...
| --- | --- | --- | --- |
| PHP compatibility | [Compatibility roadmap](roadmap-compatibility.md) | [Compatibility Agent](agent-strategy-compatibility.md) | The pinned PHP 8.5 AMD64 main pass set reaches 4,184/5,599, +13/-0 from the preceding checkpoint with zero XFAIL, timeout or crash. The by-reference-temporary checkpoint distinguishes writable aliases, notice-producing call/new temporaries and direct rvalue errors across positional/named calls, including origin and nested side-effect order. The full array audit reaches 787/842, +7/-0, with no timeout or crash; the focused diagnostic cluster reaches 27/29, +19/-0. All five feature configurations, unsafe, Composer S0, Symfony S1 and PHP 8.5.9 S2/S3 pass; all three affected release lanes remain below the +5% median ceiling. The remaining 1,119 Zend/lang failures, 41 array-suite failures and broader PHP compatibility remain explicit work. |
