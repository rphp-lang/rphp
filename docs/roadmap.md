...
| --- | --- | --- | --- |
| PHP compatibility | [Compatibility roadmap](roadmap-compatibility.md) | [Compatibility Agent](agent-strategy-compatibility.md) | The pinned PHP 8.5.6 AMD64 checkpoint is 2,430/5,599 with zero crashes or timeouts; Closure static defaults now match PHP 8.5's pre-call debug state, with deferred symbolic-default behavior next. |
