...
| --- | --- | --- | --- |
| PHP compatibility | [Compatibility roadmap](roadmap-compatibility.md) | [Compatibility Agent](agent-strategy-compatibility.md) | The pinned PHP 8.5.6 AMD64 checkpoint is 2,170/5,599 with zero crashes or timeouts; reference-returning property getters now preserve aliases and enforce interface/backing diagnostics, with indirect modification, by-reference iteration, parent-hook and Reflection forms next. |
