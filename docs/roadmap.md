...
| --- | --- | --- | --- |
| PHP compatibility | [Compatibility roadmap](roadmap-compatibility.md) | [Compatibility Agent](agent-strategy-compatibility.md) | The pinned PHP 8.5.6 AMD64 checkpoint is 1,854/5,599 with zero crashes or timeouts; close the remaining pipe interactions by their general diagnostic and call-semantics roots, then select the next highest-fanout cluster. |
