...
| --- | --- | --- | --- |
| PHP compatibility | [Compatibility roadmap](roadmap-compatibility.md) | [Compatibility Agent](agent-strategy-compatibility.md) | The pinned PHP 8.5.6 AMD64 checkpoint is 2,446/5,599 with zero crashes or timeouts; final CV replacement runs destructors with PHP's assignment, reference, foreach and static-binding ordering. Property replacement, generator finalization and request shutdown remain next. |
