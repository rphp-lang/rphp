...
| --- | --- | --- | --- |
| PHP compatibility | [Compatibility roadmap](roadmap-compatibility.md) | [Compatibility Agent](agent-strategy-compatibility.md) | The pinned PHP 8.5.6 AMD64 checkpoint is 2,435/5,599 with zero crashes or timeouts; dynamic static initializers are lazy and recursive-safe, with trait/closure storage ownership, global collisions and destructor timing next. |
