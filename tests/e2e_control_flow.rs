...
fn test_e2e_if_else_true() {
    assert_eq!(
        run_php("<?php if (1) { echo 1; } else { echo 2; }"),
        "1"
    );
}
...
fn test_e2e_if_else_false() {
    assert_eq!(
        run_php("<?php if (0) { echo 1; } else { echo 2; }"),
        "2"
    );
}
...
fn test_e2e_if_comparison() {
    assert_eq!(
        run_php("<?php $x = 10; if ($x == 10) echo 42;"),
        "42"
    );
}
...
fn test_e2e_if_comparison_false() {
    assert_eq!(
        run_php("<?php $x = 10; if ($x == 20) echo 42;"),
        ""
    );
}
...
fn test_e2e_if_less_than() {
    assert_eq!(
        run_php("<?php $x = 5; if ($x < 10) echo 42;"),
        "42"
    );
}
...
fn test_e2e_elseif_first() {
    assert_eq!(
        run_php("<?php $x = 1; if ($x == 1) { echo \"one\"; } elseif ($x == 2) { echo \"two\"; } else { echo \"other\"; }"),
        "one"
    );
}
...
fn test_e2e_elseif_second() {
    assert_eq!(
        run_php("<?php $x = 2; if ($x == 1) { echo \"one\"; } elseif ($x == 2) { echo \"two\"; } else { echo \"other\"; }"),
        "two"
    );
}
...
fn test_e2e_elseif_else() {
    assert_eq!(
        run_php("<?php $x = 3; if ($x == 1) { echo \"one\"; } elseif ($x == 2) { echo \"two\"; } else { echo \"other\"; }"),
        "other"
    );
}
...
fn test_e2e_else_if_two_tokens() {
    assert_eq!(
        run_php("<?php $x = 2; if ($x == 1) { echo \"one\"; } else if ($x == 2) { echo \"two\"; } else { echo \"other\"; }"),
        "two"
    );
}
...
fn test_e2e_elseif_chain() {
    assert_eq!(
        run_php("<?php $x = 3; if ($x == 1) { echo \"a\"; } elseif ($x == 2) { echo \"b\"; } elseif ($x == 3) { echo \"c\"; } else { echo \"d\"; }"),
        "c"
    );
}
...
fn test_e2e_switch_match_first() {
    assert_eq!(
        run_php("<?php $x = 1; switch ($x) { case 1: echo \"one\"; break; case 2: echo \"two\"; break; }"),
        "one"
    );
}
...
fn test_e2e_switch_match_second() {
    assert_eq!(
        run_php("<?php $x = 2; switch ($x) { case 1: echo \"one\"; break; case 2: echo \"two\"; break; }"),
        "two"
    );
}
...
fn test_e2e_switch_no_match() {
    assert_eq!(
        run_php("<?php $x = 99; switch ($x) { case 1: echo \"one\"; break; case 2: echo \"two\"; break; }"),
        ""
    );
}
...
fn test_e2e_switch_default() {
    assert_eq!(
        run_php("<?php $x = 99; switch ($x) { case 1: echo \"one\"; break; default: echo \"other\"; break; }"),
        "other"
    );
}
...
fn test_e2e_switch_fallthrough() {
    ...
    assert_eq!(
        run_php("<?php $x = 1; switch ($x) { case 1: echo \"a\"; case 2: echo \"b\"; case 3: echo \"c\"; }"),
        "abc"
    );
}
...
fn test_e2e_switch_fallthrough_partial() {
    ...
    assert_eq!(
        run_php("<?php $x = 2; switch ($x) { case 1: echo \"a\"; break; case 2: echo \"b\"; case 3: echo \"c\"; break; }"),
        "bc"
    );
}
...
fn test_e2e_switch_string() {
    assert_eq!(
        run_php("<?php $x = \"hello\"; switch ($x) { case \"hi\": echo 1; break; case \"hello\": echo 2; break; default: echo 3; }"),
        "2"
    );
}
...
fn test_e2e_switch_default_middle() {
    ...
    assert_eq!(
        run_php("<?php $x = 99; switch ($x) { case 1: echo \"a\"; break; default: echo \"d\"; break; case 2: echo \"b\"; break; }"),
        "d"
    );
}
...
fn test_e2e_switch_in_loop() {
    assert_eq!(
        run_php("<?php for ($i = 0; $i < 3; $i++) { switch ($i) { case 0: echo \"a\"; break; case 1: echo \"b\"; break; default: echo \"c\"; } }"),
        "abc"
    );
}
...
fn test_e2e_switch_nested_in_loop() {
    ...
    assert_eq!(
        run_php("<?php $r = ''; for ($i = 1; $i <= 4; $i++) { switch ($i) { case 1: $r .= 'a'; break; case 3: $r .= 'c'; break; default: $r .= 'x'; break; } } echo $r;"),
        "axcx"
    );
}
...
fn test_e2e_loop_inside_switch() {
    ...
    assert_eq!(
        run_php("<?php $x = 1; switch ($x) { case 1: $i = 0; while ($i < 3) { echo $i; $i++; } break; case 2: echo 'no'; break; }"),
        "012"
    );
}
...
fn test_e2e_switch_nested_switch() {
    ...
    assert_eq!(
        run_php("<?php $a = 1; $b = 2; switch ($a) { case 1: switch ($b) { case 1: echo 'aa'; break; case 2: echo 'ab'; break; } break; case 2: echo 'b'; break; }"),
        "ab"
    );
}
...
fn test_e2e_switch_default_middle_match_later_case() {
    ...
    assert_eq!(
        run_php("<?php $x = 2; switch ($x) { case 1: echo 'a'; break; default: echo 'd'; break; case 2: echo 'b'; break; }"),
        "b"
    );
}
...
fn test_e2e_switch_default_first_match_later() {
    ...
    assert_eq!(
        run_php("<?php $x = 2; switch ($x) { default: echo 'd'; break; case 1: echo 'a'; break; case 2: echo 'b'; break; }"),
        "b"
    );
}
...
fn test_e2e_switch_continue_acts_as_break() {
    ...
    assert_eq!(
        run_php("<?php $x = 1; switch ($x) { case 1: echo 'a'; continue; echo 'X'; case 2: echo 'b'; }"),
        "a"
    );
}
...
fn test_e2e_switch_continue_in_loop_context() {
    ...
    assert_eq!(
        run_php("<?php $r = ''; for ($i = 0; $i < 3; $i++) { switch ($i) { case 0: $r .= 'skip'; continue; default: $r .= $i; } } echo $r;"),
        "skip12"
    );
}
...
fn test_e2e_switch_double_default_parse_error() {
    ...
    let tokens = Lexer::new("<?php switch ($x) { default: echo 'a'; break; default: echo 'b'; break; }").tokenize().unwrap();
    let result = Parser::new(tokens).parse();
    assert!(result.is_err(), "multiple default branches should be a parse error");
...
fn test_e2e_switch_default_fallthrough_to_case() {
    ...
    assert_eq!(
        run_php("<?php $x = 99; switch ($x) { case 1: echo 'a'; break; default: echo 'd'; case 2: echo 'b'; break; }"),
        "db"
    );
}
